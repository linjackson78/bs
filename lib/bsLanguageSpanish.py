...
values = {
    'accountSettingsWindow':{
        ...
        'linkAccountsInstructionsText':('Para conectar dos cuentas, genera un código en \n'
                                        'una de ellas y registra el código en la otra.\n'
                                        'El progreso e inventario se combinarán.\n'
                                        'Puedes conectar hasta ${COUNT} cuentas.\n'
                                        '\n'
    ...
    'achievementsUnavailableForOldSeasonsText':'Lo sentimos, los logros específicos no están availables para sesiones antiguas.',
    'addGameWindow':{
    ...
    'internal':{
        ...
        'joinedPartyInstructionsText':('Un amigo se ha unido a la fiesta.\n'
        ...
        'trialText':'prueba',
        'unavailableNoConnectionText':'No disponible por el momento (¿No conexión a internet?)',
        'vrOrientationResetCardboardText':('Usa esto para resetear la orientación del VR.\n'
    ...
    'playerDelayedJoinText':'${PLAYER} entrará cuando empieze el siguiente juego.',
