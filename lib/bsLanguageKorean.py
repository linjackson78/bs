...
values = {
    'accountSettingsWindow':{
        ...
        'campaignProgressText':'캠페인 진행 상황 [하드]: ${PROGRESS}',
    ...
    'achievements':{
        ...
        'Free Loader':{
            'descriptionFull':'난투 게임을 두명 이상으로 시작합니다.',
            'descriptionFullComplete':'난투 게임을 두명 이상으로 시작했습니다.',
            'name':'격투가'
        },
        'Gold Miner':{
    ...
    'allowText':'허용',
    'apiVersionErrorText':'${NAME} 모듈을 불러올 수 없습니다; ${VERSION_USED} api 버전을 목표로 합니다; ${VERSION_REQUIRED} 버전이 필요합니다.',
    'audioSettingsWindow':{
    ...
    'bestOfSeriesText':'베스트 ${COUNT} 시리즈:',
    ...
    'difficultyEasyText':'용이',
    'difficultyHardOnlyText':'하드 모드만',
    'difficultyHardText':'하드',
    'difficultyHardUnlockOnlyText':('이 레벨은 하드 모드에서만 잠금 해제할 수 있습니다.\n'
                                    '준비가 되셨습니까?'),
    ...
    'gatherWindow':{
        ...
        'partyInviteGooglePlayExtraText':'(\'파티 모으기\' 창에서 \'Google Play\' 탭을 확인하세요)',
        ...
        'titleText':'파티 모으기',
        'wifiDirectDescriptionBottomText':('모든 장치에 \'Wi-Fi Direct\' 패널이 있으면 이를 통해서 서로 찾고 연결할 수 있어야\n'
                                           '합니다. 모든 장치가 연결되면 일반 Wi-Fi 네트워크와 똑같이 \'로컬 네트워크\' 탭을\n'
                                           '이용해 이곳에서 파티를 결성할 수 있습니다.\n'
                                           '\n'
                                           '최선의 결과를 얻으려면 Wi-Fi Direct 호스트가 ${APP_NAME} 파티 호스트이어야 합니다.'),
        'wifiDirectDescriptionTopText':('Wi-Fi Direct는 Wi-Fi 네트워크 없이 직접 안드로이드 장치들을 연결하는 데\n'
                                        '사용될 수 있습니다. 이 기능은 안드로이드 버전 4.2 이상에서 가장 잘 작동합니다.\n'
                                        '\n'
                                        '이 기능을 사용하려면 Wi-Fi 설정을 열고 메뉴에서 \'Wi-Fi Direct\'를 찾으세요.'),
    ...
    'helpWindow':{
        'bombInfoText':('- 폭탄 -\n'
                        ...
                        '도화선이 다 타기 전에 적들에게\n'
                        '던지는 것이 가장 좋습니다.'),
        'canHelpText':'${APP_NAME}가 도울 수 있습니다.',
        'controllersInfoText':('네트워크를 통해 친구들과 함께 ${APP_NAME}를 즐기거나\n'
                               '컨트롤러가 충분할 경우 동일한 기기에서 함께 플레이할 수 있습니다.\n'
                               '${APP_NAME}는 다양한 기기를 지원합니다. 심지어 무료\n'
                               '\'${REMOTE_APP_NAME}\' 앱을 사용해 휴대폰을 컨트롤러로 사용할 수도\n'
                               '있습니다. 자세한 사항은 설정->컨트롤러를 참고하세요.'),
        'controllersText':'컨트롤러',
        'controlsSubtitleText':'사용자의 ${APP_NAME} 캐릭터가 수행할 수 있는 기본 행동:',
        'controlsText':'컨트롤',
        ...
        'jumpInfoText':('- 점프 -\n'
                        ...
                        '물건을 더 높이 던지며 기쁜\n'
                        '감정을 표현할 수 있습니다.'),
        'orPunchingSomethingText':'또는 뭔가를 주먹으로 치거나 절벽에서 던져버리거나 떨어지는 동안 폭탄으로 날려버리고 싶을 때가 있을 겁니다.',
        'pickUpInfoText':('- 줍기 -\n'
                          '깃발, 적 또는 땅에 고정되지 않은\n'
                          '것을 움켜잡을 수 있습니다.\n'
                          '다시 누르면 던집니다.'),
        ...
        'toGetTheMostText':'이 게임을 최대한 즐기기 위해 필요한 것들:',
        'welcomeText':'${APP_NAME}에 환영합니다!'
    },
    ...
    'internal':{
        ...
        'joinedPartyInstructionsText':('친구가 파티에 가입했습니다.\n'
                                       '\'플레이\'에서 게임을 시작하세요.'),
        'keyboardText':'키보드',
    ...
    'playerDelayedJoinText':'${PLAYER} 님이 다음 게임 시작 시 참가합니다.',
    ...
    'removeInGameAdsText':'게임 내 광고를 제거하려면 스토어에서 "${PRO}"를 잠금 해제하세요.',
    'renameText':'이름 바꾸기',
    ...
    'store':{
        ...
        'extrasText':'추가',
        'freeBombSquadProText':('현재 봄스쿼드는 무료이지만, 당신은 뮤무료로 전환되기 전 구매를 하였으므로\n'
        ...
        'howToUseMapsText':'(이 지도들을 팀/난투 플레이 목록에서 사용하세요)',
        'iconsText':'아이콘',
        ...
        'saleText':'세일',
        'searchText':'검색',
        'teamsFreeForAllGamesText':'팀 / 난투 게임',
    ...
    'translations':{
        ...
        'tips':{
            ...
            ('Tired of the soundtrack?  Replace it with your own!\n'
             'See Settings->Audio->Soundtrack'):('사운드트랙이 싫증나세요? 자신의 것으로 바꾸세요!\n'
    ...
    'unlockThisInTheStoreText':'스토어에서 잠금 해제해야 합니다.',
    ...
    'upgradeText':'업그레이드',
    'upgradeToPlayText':'플레이하려면 스토어에서 "${PRO}"를 잠금 해제하세요.',
    ...
    'watchAnAdText':'광고 감상',
    'watchWindow':{
        'deleteConfirmText':'"${REPLAY}" 삭제합니까?',
        ...
        'renameReplayButtonText':('다시 보기\n'
                                  '이름 바꾸기'),
        'renameReplayText':'"${REPLAY}"의 이름 변경 후:',
        'renameText':'이름 바꾸기',
    ...
    'xbox360ControllersWindow':{
        ...
        'macInstructions2Text':('무선 컨트롤러를 무선으로 이용하기 위해선 윈도우즈용 Xbox 360 무선 컨트롤러와\n'
                                '같이 있는 무선 리시버가 필요합니다.\n'
                                '리시버 하나당 최대 4개의 컨트롤러를 연결할 수 있습니다.\n'
                                '\n'
                                '중요: 마이크로소프트 외의 회사에서 개발한 리시버의 경우 해당 드라이버와의\n'
                                '사용이 불가능 합니다; 무선 리시버에 \'XBOX 360\'이 아니라 \'Microsoft\'가\n'
                                '적혀저 있어야 합니다. 현재 마이크로소프트는 이 무선 리시버를 단품으로 팔지 않으므로\n'
                                '무선 리시버가 있는 컨트롤러를 구매거나 온라인 쇼핑몰에서 찾아야 니다.\n'
                                '\n'
