...
values = {
    ...
    'achievements':{
        ...
        'Boxer':{
            'description':'Win zonder gebruik van bommen',
    ...
    'gatherWindow':{
        ...
        'googlePlayDescriptionText':'Nodig Google Play spelers uit voor jouw partij:',
    ...
    'internal':{
        ...
        'joinedPartyInstructionsText':('Een vriend doet mee in uw partij.\n'
    ...
    'playerDelayedJoinText':'${PLAYER} zal de volgende ronde mee spelen.',
