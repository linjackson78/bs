...
values = {
    ...
    'internal':{
        ...
        'joinedPartyInstructionsText':('一位好友加入了你的派对。\n'
                                       '去“玩”游戏吧。'),
        'keyboardText':'键盘',
    ...
    'playerDelayedJoinText':'${PLAYER}将在下一局开始时进入。',
    'playerInfoText':'玩家资料',
    ...
    'settingsWindow':{
        ...
        'controllersText':'控制器',
        'graphicsText':'图像',
        'playerProfilesMovedText':'註：玩家檔案已移至主選單的「帳號」視窗',
    ...
    'translations':{
        ...
        'gameDescriptions':{
            ...
            'Gather eggs!':'收集蛋吧！',
            'Get the flag to the enemy end zone.':'将旗帜插入敌人球门区。',
        ...
        'serverResponses':{
            ...
            'Account linking successful!':'帳號連結成功！',
            'Accounts are already linked.':'帳號已經連結。',
            'An error has occurred; please contact support@froemling.net.':'發生錯誤，請聯繫 support@froemling.net。',
            ...
            'Can\'t link 2 accounts of this type.':'無法連結 2 個這種帳號。',
            'Can\'t link 2 diamond league accounts.':'無法連結兩個 diamond league 帳號。',
            'Can\'t link; would surpass maximum of ${COUNT} linked accounts.':'無法連結，會超過上限 ${COUNT} 個帳號。',
            'Cheating detected; scores and prizes suspended for ${COUNT} days.':'发现作弊行为；得分及奖励在${COUNT}天内暂停。',
            'Could not establish a secure connection.':'無法建立安全連線。',
            'Daily maximum reached.':'已达今日上限。',
            'Entering tournament...':'进入锦标赛……',
            'Invalid code.':'代码无效。',
            'Invalid promo code.':'促销代码无效。',
            'Invalid purchase.':'购买无效。',
            'Invalid tournament entry; score will be ignored.':'錯誤的聯賽資料，分數將會忽略。',
            ...
            'Sorry, there are no uses remaining on this code.':'对不起，此代码已无用。',
