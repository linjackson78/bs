...
values = {
    'accountSettingsWindow':{
        ...
        'linkAccountsGenerateCodeText':'Создать Код',
        ...
        'linkAccountsText':'Связать Аккаунты',
    ...
    'achievements':{
        'Boom Goes the Dynamite':{
            'description':'Убейте 3 злодеев с помощью TNT',
            'descriptionComplete':'С помощью TNT убито 3 злодея',
            'descriptionFull':'Убейте 3 злодеев с помощью TNT на уровне ${LEVEL}',
            'descriptionFullComplete':'3 злодея убито с помощью TNT на уровне ${LEVEL}',
        ...
        'Mine Games':{
            'description':'Убейте 3 злодеев с помощью мин',
            'descriptionComplete':'С помощью мин убито 3 злодея',
            'descriptionFull':'Убейте 3 злодеев с помощью мин на уровне ${LEVEL}',
        ...
        'Pro Football Shutout':{
            'description':'Победите, не дав негодяям набрать очков',
        ...
        'Stayin\' Alive':{
            ...
            'descriptionFullComplete':'Победа на уровне ${LEVEL} без потерь',
        ...
        'TNT Terror':{
            ...
            'descriptionFullComplete':'С помощью TNT убито 6 негодяев на уровне ${LEVEL}',
        ...
        'Uber Football Shutout':{
            'description':'Выиграйте, не дав негодяям забить',
            'descriptionComplete':'Победа в сухую',
            'descriptionFull':'Выиграйте матч ${LEVEL} в сухую',
            'descriptionFullComplete':'Победа в матче ${LEVEL} в сухую',
            'name':'${LEVEL} в сухую'
    ...
    'hostIsNavigatingMenusText':'- ${HOST} находится в меню навигации',
    ...
    'internal':{
        ...
        'joinedPartyInstructionsText':('Друг вошел в ваше лобби.\n'
    ...
    'playerDelayedJoinText':'${PLAYER} присоединится в начале следующей игры.',
    ...
    'translations':{
        ...
        'serverResponses':{
            ...
            'Can\'t link; would surpass maximum of ${COUNT} linked accounts.':'Невозможно связать; будет превзойден максимум ${COUNT} связанных аккаунтов.',
            ...
            'Invalid tournament entry; score will be ignored.':'Неверная заявка на турнир; счет будет игнорироваться.',
            'Max number of playlists reached.':'Максимальное количество плейлистов достигнута.',
            ...
            ('Received ${COUNT} tickets for signing in.\n'
             'Come back tomorrow to receive ${TOMORROW_COUNT}.'):('Поступившие ${COUNT} билеты за вход.\n'
        ...
        'tips':{
            ...
            ('Create player profiles for yourself and your friends with\n'
             'your preferred names and appearances instead of using random ones.'):('Создайте профили игроков для себя и своих друзей с собствнными\n'
            ...
            ('You can \'aim\' your punches by spinning left or right.\n'
             'This is useful for knocking bad guys off edges or scoring in hockey.'):('Вы можете \'нацеливать\' удары, крутясь влево или вправо.\n'
                                                                                      'Это полезно для сталкивания злодеев с края или для голов в хоккее.'),
