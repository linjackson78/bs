...
values = {
    'accountSettingsWindow':{
        ...
        'campaignProgressText':'Kampagneprocess: ${PROGRESS}',
        'notLoggedInText':'<ikke logget ind>',
        'resetProgressConfirmNoAchievementsText':('Dette vil nulstille din co-op fremskridt og dine\n'
                                                  'lokale high-schores (men ikke dine tickets).\n'
                                                  'Dette kan ikke gøres om. Er du sikker?'),
        ...
        'signInInfoText':('Log ind for at gemme dine fremskridt i \n'
                          'skyen, gemte tickets\n'
                          'og vunde turneringer.'),
        'signInText':'Log Ind',
        'signOutText':'Log ud',
    ...
    'bombBoldText':'BOMB',
    'bombText':'Bomb',
    'bsRemoteConfigureInAppText':'BombSquad Remote konfigureres i selve app\'en',
    'buttonText':'Knap',
    ...
    'connectMobileDevicesWindow':{
        ...
        'explanationText':('For at bruge en smartphone eller tablet som en trådløs controller,\n'
                           'skal du installere app\'en "BombSquad Remote". Et utal af enheder\n'
                           'kan forbinde til et BombSquad spil via WiFi, og det er helt gratis!'),
        'forAndroidText':'til Android:',
        'forIOSText':'til iOS:',
        'getItForText':('Få BombSquad Remote til iOS i Apples App Store eller til\n'
                        'Android på Googles Play Store eller Amazon Appstore'),
    ...
    'fireTVRemoteWarningText':('*For at få den bedste oplevelse, brug spilcontrollere eller installer\n'
    ...
    'helpWindow':{
        ...
        'friendsGoodText':('Disse er gode at have. BombSquad er sjovest at spille med flere spillere,\n'
        ...
        'powerupBombDescriptionText':('Tre gange flere bomber.\n'
                                      'Tre gange mere sjov.'),
