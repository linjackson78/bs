...
class FootballCoopGame(bs.CoopGameActivity):
    ...
    def __init__(self,settings={}):
        ...
        self._timeElapsedText = bs.getResource('timeElapsedText')
    ...
    def _updateTime(self,forceValue=None):
        try:
            ...
            self._timeText.node.text = self._timeElapsedText+': '+bs.getTimeString((t/10)*10)
        except Exception:
            bs.printException()
