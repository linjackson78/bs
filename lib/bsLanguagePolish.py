...
values = {
    ...
    'coopSelectWindow':{
        ...
        'totalText':'Suma',
        'tournamentInfoText':('Graj o wysokie wyniki z innymi graczami z twej ligi.\n'
                              '\n'
                              'Nagrody dostają gracze\n'
                              'z najlepszymi wynikami\n'
                              'kiedy czas zawodów wygasa.'),
    ...
    'internal':{
        ...
        'joinedPartyInstructionsText':('Znajomy wbił się na imprezę.\n'
                                       'Aby rozpocząć grę naciśnij \'Graj\'.'),
    ...
    'playerCountAbbreviatedText':'${COUNT} część',
