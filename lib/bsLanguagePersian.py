...
values = {
    'accountSettingsWindow':{
        ...
        'linkAccountsInstructionsText':('برای وصل کردن دو حساب ، در یکی از آنها\n'
                                        'کدی ایجاد کرده و آن را در دیگری وارد کنید.\n'
                                        'پیشرفت ها و موجودی ترکیب خواهد شد.\n'
                                        'حساب را وصل کنید ${COUNT} شما میتوانید.\n'
                                        '\n'
                                        'مراقب باشید ؛ این کار نمی تواند ناتمام بماند'),
        ...
        'resetProgressConfirmNoAchievementsText':('همه ی پیشرفت شما در بخش همکاری و بالاترین امتیازات شما پاک خواهد شد.\n'
                                                  ...
                                                  'این کار نمیتواند ناتمام بماند ، آیا مطمئنید ؟'),
        ...
        'signInWithDeviceText':'وصل شدن با حساب دستگاه خود',
        'signInWithGameCircleText':'وصل شدن از طریق حوزه ی بازی',
        'signInWithGooglePlayText':'وصل شدن با حساب گوگل خود',
        'signInWithTestAccountInfoText':'(اکانت میراثی؛ از حساب های قدیمی استفاده میشود)',
        'signInWithTestAccountText':'وصل شدن با حساب آزمایشی',
        'signOutText':'خارج شدن از حساب',
    ...
    'achievementChallengesText':'چالش ها برای گرفتن دستاورد',
    ...
    'achievements':{
        ...
        'Boxer':{
            'description':'بدون استفاده از هر نوع بمبی برنده شو',
            'descriptionComplete':'بدون استفاده از هر نوع بمبی برنده شدی',
            'descriptionFull':'را بدون استفاده از هر نوع بمبی تمام کن ${LEVEL} مرحله',
        ...
        'Free Loader':{
            ...
            'descriptionFullComplete':'.بازی هرکی برا خودش با دو بازیکن یا بیشتر شروع کردی',
            'name':'بالا آور رایگان'
        },
        'Gold Miner':{
            'description':'شش حریف را با مین زمینی نابود کن',
            'descriptionComplete':'شش حریف را با مین زمینی نابود کردی',
            'descriptionFull':'با مین زمینی نابود کن ${LEVEL}شش حریف را در مرحله',
    ...
    'gatherWindow':{
        ...
        'partyInviteGooglePlayExtraText':'(صفحه ی گوگل پلی را در صفحه ی"جمع کردن" ببینید)',
    ...
    'internal':{
        ...
        'joinedPartyInstructionsText':('یه دوست به گروه بازی پیوسته\n'
                                       'برید به بازی و بازی رو شروع کنید'),
    ...
    'playerDelayedJoinText':'در بازی بعدی ملحق می شود ${PLAYER}',
    ...
    'store':{
        ...
        'saleText':'فروش ویژه',
        'searchText':'جسنجو',
        'teamsFreeForAllGamesText':'بازی های تیمی یا هرکی برا خودش',
    ...
    'translations':{
        ...
        'gameNames':{
            ...
            'Chosen One':'صاحب پرچم',
            'Conquest':'قدرت نمایی',
            'Death Match':'نبرد سخت',
        ...
        'serverResponses':{
            ...
            'You don\'t have enough tickets for this!':'شما بلیت کافی برای این ندارید',
            'You got ${COUNT} tickets!':'! تا بلیت گرفتی ${COUNT}',
            ...
            ('Your copy of the game has been modified.\n'
             'Please revert any changes and try again.'):('Your copy of the game has been modified.\n'
    ...
    'wiimoteSetupWindow':{
        ...
        'thanksText':'تشکر از تیم ناظر برای ساخت این امکان',
