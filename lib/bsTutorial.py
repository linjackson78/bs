...
class TutorialActivity(bs.Activity):
    ...
    def __init__(self,settings={}):
        ...
        self._R = bs.getResource('tutorial')
    ...
    def _readEntries(self):
        ...
        try:
            ...
            R = bs.getResource('tutorial')
            self._entries = [Reset(),
                             SpawnSpaz(0,(0,5.5,-3.0),makeCurrent=True),
                             DelayOld(1000),
                             AnalyticsScreen('Tutorial Section 1'),
                             Text(R.phrase01Text), # hi there
                             Celebrate('left'),
                             DelayOld(2000),
                             Text(R.phrase02Text.replace('${APP_NAME}',bs.getResource('titleText'))), # welcome to bombsquad
                             ...
                             DelayOld(1500),
                             Text(R.phrase03Text), # here's a few tips
                             DelayOld(1000),
                             ShowControls(),
                             DelayOld(1000),
                             Jump(),
                             ...
                             Text(R.phrase04Text.replace('${APP_NAME}',bs.getResource('titleText'))), # many things are based on physics
                             ...
                             Move(0,0),
                             DelayOld(1000),
                             Text(R.phrase05Text), # for example when you punch..
                             DelayOld(510),
                             Move(0,-0.01),
                             DelayOld(100),
                             Move(0,0),
                             ...
                             SpawnSpaz(1,(-3.1, 4.3, -2.0),makeCurrent=False,color=(1,1,0.4),name=R.randomName1Text),
                             Move(-1.0,0),
                             DelayOld(1050),
                             Move(0,-0.01),
                             DelayOld(100),
                             Move(0,0),
                             DelayOld(1000),
                             Text(R.phrase06Text), # your damage is based
                             DelayOld(1200),
                             Move(-0.05,0),
                             DelayOld(200),
                             Punch(),
                             ...
                             DelayOld(100),
                             Move(0,0),
                             Text(R.phrase07Text.replace('${NAME}',R.randomName1Text)), # see that didnt hurt fred
                             DelayOld(2000),
                             Celebrate('right',spazNum=1),
                             DelayOld(1400),
                             Text(R.phrase08Text), # lets jump and spin to get more speed
                             ...
                             Move(0,0),
                             DelayOld(1000),
                             Text(R.phrase09Text), # ah thats better
                             DelayOld(1900),
                             AnalyticsScreen('Tutorial Section 3'),
                             Text(R.phrase10Text), # running also helps
                             DelayOld(100),

                             SpawnSpaz(0,(-3.2, 4.3, -4.4),makeCurrent=True,flash=False),
                             SpawnSpaz(1,(3.3, 4.2, -5.8),makeCurrent=False,color=(0.9,0.5,1.0),name=R.randomName2Text),
                             DelayOld(1800),
                             Text(R.phrase11Text), # hold ANY button to run
                             DelayOld(300),
                             ...
                             Text(R.phrase12Text), # for extra-awesome punches,...
                             DelayOld(200),

                             SpawnSpaz(0,(2.368781805038452, 4.337533950805664, -4.360159873962402),makeCurrent=True,flash=False),
                             SpawnSpaz(1,(-3.2, 4.3, -4.5),makeCurrent=False,color=(1.0,0.7,0.3),name=R.randomName3Text),
                             DelayOld(100),
                             ...
                             Text(R.phrase13Text.replace('${NAME}',R.randomName3Text)), # whoops sorry bill
                             RemoveGloves(),
                             DelayOld(2000),
                             AnalyticsScreen('Tutorial Section 5'),
                             Text(R.phrase14Text.replace('${NAME}',R.randomName4Text)), # you can pick up and throw things such as chuck here
                             SpawnSpaz(0,(-4.0, 4.3, -2.5),makeCurrent=True,flash=False,angle=90),
                             SpawnSpaz(1,(5,0,-1.0),relativeTo=0,makeCurrent=False,color=(0.4,1.0,0.7),name=R.randomName4Text),
                             DelayOld(1000),
                             ...
                             Text(R.phrase15Text), # lastly theres bombs
                             DelayOld(1900),
                             Text(R.phrase16Text), # throwing bombs takes practice
                             DelayOld(2000),
                             Bomb(),
                             Move(-0.1,-0.1),
                             DelayOld(100),
                             ...
                             Bomb(),
                             DelayOld(2000),
                             Text(R.phrase17Text), # not a very good throw
                             DelayOld(3000),
                             Text(R.phrase18Text), # moving helps you get distance
                             DelayOld(1000),
                             Bomb(),
                             DelayOld(500),
                             Move(-0.3,0),
                             ...
                             Move(0,0),
                             DelayOld(2500),
                             Text(R.phrase19Text), # jumping helps you get height
                             DelayOld(2000),
                             Bomb(),
                             DelayOld(500),
                             Move(1,0),
                             ...
                             Move(0,0),
                             DelayOld(2000),
                             Text(R.phrase20Text), # whiplash your bombs
                             DelayOld(1000),
            ...
            DelayOld2(10),MoveLR(-0.70983),JumpRelease(),DelayOld2(30),MoveLR(-0.592181),MoveUD(-0.0588092),DelayOld2(10),MoveLR(-0.490219),MoveUD(-0.0744957),DelayOld2(10),MoveLR(-0.41963),DelayOld2(20),MoveLR(0),MoveUD(0),DelayOld2(20),MoveUD(0),
                             ...
                             Text(R.phrase21Text), # timing your bombs can be tricky
                             Move(-1,0),
                             DelayOld(1000),
                             Move(0,-0.1),
                             DelayOld(100),
                             ...
                             SpawnSpaz(1,(6.5,0,-0.75),relativeTo=0,makeCurrent=False,color=(0.3,0.8,1.0),name=R.randomName5Text),
                             DelayOld2(1000),
                             Move(-1,0),
                             DelayOld2(1800),
                             Bomb(),
                             ...
                             Move(0,0),
                             DelayOld2(1500),
                             Text(R.phrase22Text), # dang
                             Delay(1500),
                             Text(''),
                             Delay(200),
                             Text(R.phrase23Text), # try cooking off
                             Delay(1500),
                             Bomb(),
                             Delay(800),
                             Move(1,0.12),
                             ...
                             Move(0,0),
                             Delay(2000),
                             Text(R.phrase24Text), # hooray nicely cooked
                             Celebrate(),
                             #SetSpeed(3),
                             DelayOld(2000),
                             KillSpaz(1),
                             ...
                             Text(R.phrase25Text), # well thats just about it
                             DelayOld(2000),
                             Text(R.phrase26Text), # go get em tiger
                             DelayOld(2000),
                             Text(R.phrase27Text), # remember you training
                             DelayOld(3000),
                             Text(R.phrase28Text), # well maybe
                             DelayOld(1600),
                             Text(R.phrase29Text), # good luck
