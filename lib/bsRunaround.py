...
class RunaroundGame(bs.CoopGameActivity):
    ...
    def onBegin(self):
        ...
        lOffs = -20 if bs.getEnvironment()['interfaceType'] == 'phone' else 0
    ...
    def _awardCompletionBonus(self):
        ...
        bs.PopupText('+'+str(bonus)+' '+bs.getResource('completionBonusText'),
                           color=(0.7,0.7,1.0,1),
                           scale=1.6,
    ...
    def _awardLivesBonus(self,):
        ...
        bs.playSound(self._cashRegisterSound)
        bs.PopupText('+'+str(bonus)+' '+bs.getResource('livesBonusText'),
                           color=(0.7,1.0,0.3,1),
                           scale=1.3,
    ...
    def _awardFlawlessBonus(self):
        bs.playSound(self._cashRegisterSound)
        bs.PopupText('+'+str(self._flawlessBonus)+' '+bs.getResource('perfectWaveText'),
                           color=(1,1,0.2,1),
                           scale=1.2,
    ...
    def _startNextWave(self):
        ...
        self._timeBonusText = bs.NodeActor(bs.newNode('text',
                                                      attrs={'vAttach':'top',
                                                             ...
                                                             'position':(0,-60),
                                                             'scale':0.8,
                                                             'text':bs.getResource('timeBonusText')+': '+str(int(self._timeBonus*self._timeBonusMult))}))
    ...
    def _updateTimeBonus(self):
        ...
        if self._timeBonus > 0 and self._timeBonusText is not None:
            self._timeBonusText.node.text = bs.getResource('timeBonusText')+': '+str(int(self._timeBonus*self._timeBonusMult))
