...
values = {
    ...
    'gatherWindow':{
        ...
        'publicPartyDescriptionText':'Join a public party:',
    ...
    'internal':{
        ...
        'joinedPartyInstructionsText':('A friend has joined your party.\n'
    ...
    'playerDelayedJoinText':'${PLAYER} will enter at the start of the next game.',
