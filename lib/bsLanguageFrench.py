...
values = {
    ...
    'bestRatingText':'Votre meilleur évaluation est ${RATING}',
    ...
    'configGamepadWindow':{
        ...
        'pressAnyButtonOrDpadText':'Appuyer sur n\'importe quel bouton ou croix directionelle...',
        'pressAnyButtonText':'Appuyer sur n\'importe quel bouton...',
        'pressLeftRightText':'Appuyer à gauche ou à droite...',
        'pressUpDownText':'Appuyer en haut ou en bas...',
        'runButton1Text':'Faire fonctionner le Bouton 1',
        'runButton2Text':'Faire fonctionner le Bouton 2',
        'runTrigger1Text':'Faire fonctionner la Gâchette 1',
        'runTrigger2Text':'Faire fonctionner la Gâchette 2',
        ...
        'startButtonActivatesDefaultDescriptionText':'(décochez ceci si votre bouton start est plus considéré comme un bouton \'menu\')',
    ...
    'configTouchscreenWindow':{
        'actionControlScaleText':'Grosseur des boutons d\'actions',
        'actionsText':'Actions',
        'buttonsText':'boutons',
        'dragControlsText':'< bougez les contrôles pour les repositionner >',
        'joystickText':'Joystick',
        'movementControlScaleText':'Grosseur des boutons de mouvements',
    ...
    'coopSelectWindow':{
        ...
        'pointsText':'Points',
        'powerRankingFinishedSeasonUnrankedText':'(saison terminé non-classé)',
    ...
    'gatherWindow':{
        ...
        'aboutDescriptionText':('Utilisez ces onglets pour créer un salon.\n'
                                '\n'
                                'Les salons vous permettent de faire des jeux et \n'
                                'tournois avec vos amis entre différents appareils.\n'
                                '\n'
                                'Utilisez le bouton ${PARTY} en haut à droite pour\n'
                                'discuter et interagir avec votre salon. (sur une \n'
        ...
        'bluetoothDescriptionText':'Héberger/Joindre un salon via Bluetooth:',
        ...
        'disconnectClientsText':('Ceci déconnectera le(s) ${COUNT} joueur(s)\n'
                                 'de votre salon. En êtes vous sûr(e)?'),
        ...
        'googlePlayDescriptionText':'Invitez des joueurs Google Play à votre salon:',
        ...
        'localNetworkDescriptionText':'Joindre un salon sur votre réseau:',
        'localNetworkText':'Réseau Local',
        'manualAddressText':'Adresse',
        'manualConnectText':'Connexion',
        'manualDescriptionText':'Joindre un salon via adresse ip:',
    ...
    'internal':{
        ...
        'buttonText':'bouton',
        'connectedToPartyText':'Vous avez joint le salon de ${NAME}!',
        'connectingToPartyText':'Connexion...',
        'connectionFailedHostAlreadyInPartyText':'La connexion a échouée; l\'hôte est dans un autre salon.',
        ...
        'joinedPartyInstructionsText':('Un ami a joint votre salon.\n'
                                       'Allez à \'Jouer\' pour commencer un jeu.'),
        ...
        'leftPartyText':'Vous avez quitté le salon de ${NAME}.',
        'noMusicFilesInFolderText':'Ce dossier contient aucun fichier musical.',
        'playerJoinedPartyText':'${NAME} a joint le salon!',
        'playerLeftPartyText':'${NAME} a quitté le salon.',
        'rejectingInviteAlreadyInPartyText':'Rejeter l\'invitation (déjà dans un salon).',
    ...
    'mainMenu':{
        ...
        'leavePartyConfirmText':'Voulez-vous vraiment quitter le salon?',
        'leavePartyText':'Quitter le salon',
    ...
    'partyWindow':{
        ...
        'emptyText':'Votre salon est vide',
        'hostText':'(hôte)',
        'sendText':'Envoyer',
        'titleText':'Votre salon'
    },
    ...
    'playerDelayedJoinText':'${PLAYER} rejoindra au commencement du prochain jeu.',
    ...
    'quittingIn5SecondsText':'Le jeu fermera en 5 secondes...',
    ...
    'reachWave2Text':'Atteignez la 2e vague pour vous classé.',
    'readyText':'prêt',
    'recentText':'Récents',
    ...
    'settingsWindow':{
        ...
        'playerProfilesMovedText':'Note: les Profiles de Joueurs ont été déplacer dans la page de Compte, dans le menu principal.',
    ...
    'store':{
        ...
        'holidaySpecialText':'Spécial Vacance',
    ...
    'storeDescriptions':{
        ...
        'teamUpAgainstComputerText':'Grouper contre l\'ordinateur.'
    },
    'storeText':'Magasin',
    ...
    'translations':{
        ...
        'serverResponses':{
            'A code has already been used on this account.':'Un code a été déjà utiliser sur ce compte.',
            ...
            ('Your copy of the game has been modified.\n'
             'Please revert any changes and try again.'):('Votre copie du jeu a été modifié.\n'
                                                          'Réinitialisez tous changements et réessayer.'),
        ...
        'settingNames':{
            ...
            'Balance Total Lives':'Balancer le total des vies',
        ...
        'tips':{
            ...
            ('Create player profiles for yourself and your friends with\n'
             'your preferred names and appearances instead of using random ones.'):('Créez un profil de joueur pour vous même et vos amis avec vos noms\n'
                                                                                    'et apparences préférés au lieu d\'utilisez ceux au hasard.'),
            ...
            'Hold any button to run.  (Trigger buttons work well if you have them)':'Gardez n\'importe quel bouton appuyer pour courir. (Les gâchettes marchent aussi si vous avez)',
            ('Hold down any button to run. You\'ll get places faster\n'
             'but won\'t turn very well, so watch out for cliffs.'):('Gardez n\'importe quel bouton appuyer pour courir. Vous arriverez aux endroits \n'
            ...
            ('If you get a sticky-bomb stuck to you, jump around and spin in circles. You might\n'
             'shake the bomb off, or if nothing else your last moments will be entertaining.'):('Si une bombe-gluant est coller à vous, sautez et tournez. Vous pourriez vous \n'
                                                                                                'débarrasser, si ça ne fonctionne pas vos derniers instants seront divertissant.'),
            'If you kill an enemy in one hit you get double points for it.':'Si vous tuez un ennemi dans un frappe vous obtiendriez deux fois plus de points.',
            ...
            ('In Capture-the-Flag, your own flag must be at your base to score, If the other\n'
             'team is about to score, stealing their flag can be a good way to stop them.'):('Dans Capturer le Drapeau, votre propre drapeau doit être à votre base pour marquer un point. Si l\'autre\n'
                                                                                             'équipe est proche à marquer, vous pouvez les ralentir par voler leur drapeau.'),
            ...
            'It\'s easier to win with a friend or two helping.':'C\'est plus facile à gagner avec l\'aide d\'un ou deux amis.',
            ...
            'Land-mines are a good way to stop speedy enemies.':'Les mines terrestres sont un bon façon de ralentir les ennemis.',
            ...
            ('Players can join and leave in the middle of most games,\n'
             'and you can also plug and unplug controllers on the fly.'):('Les joueurs peuvent joindre et quitter quand les jeux sont en progrès, \n'
            ...
            'Practice using your momentum to throw bombs more accurately.':'Entraînez à utiliser votre momentum pour vous lancez les bombes plus précisément.',
            ('Punches do more damage the faster your fists are moving,\n'
             'so try running, jumping, and spinning like crazy.'):('Les poinçons font plus de dommage quand vous bougez plus vite,\n'
                                                                   'essayez à courir, sauter, et tourner comme un fou.'),
            ('Run back and forth before throwing a bomb\n'
             'to \'whiplash\' it and throw it farther.'):('Courez en arrière et en avant puis lancer\n'
                                                          'votre bombe pour lancer plus loin.'),
            ('Take out a group of enemies by\n'
             'setting off a bomb near a TNT box.'):('Éliminez un groupe d\'ennemis par \n'
                                                    'exploser une bombe près du TNT.'),
            ('The head is the most vulnerable area, so a sticky-bomb\n'
             'to the noggin usually means game-over.'):('La tête est la plus vulnérable, une \n'
                                                        'bombe gluante au tête c\'est game-over.'),
            ...
            ('Throw strength is based on the direction you are holding.\n'
             'To toss something gently in front of you, don\'t hold any direction.'):('La force du lancé est basée sur la direction que vous maintenez.\n'
                                                                                      'Pour lancez gentiment devant vous, maintenez aucun direction.'),
            ('Tired of the soundtrack?  Replace it with your own!\n'
             'See Settings->Audio->Soundtrack'):('Ennuyez par la bande sonore? Remplacez avec votre propre!\n'
                                                 'Allez à Paramètres->Audio->Bande Sonore'),
            'Try \'Cooking off\' bombs for a second or two before throwing them.':'Essayez à tenir les bombes pour quelques secondes avant que vous lancez.',
            'Try tricking enemies into killing eachother or running off cliffs.':'Essayez de duper vos ennemis à tuent ils-mêmes ou courir hors des falaises.',
            ...
            ('You can \'aim\' your punches by spinning left or right.\n'
             'This is useful for knocking bad guys off edges or scoring in hockey.'):('Vous pouvez \'viser\' vos poinçons en tournant à droite ou à gauche.\n'
            ...
            'Your punches do much more damage if you are running or spinning.':'Vos poinçons font plus de dommage si vous êtes en train de courir ou tourner.'
        }
    },
    ...
    'tutorial':{
        ...
        'phrase03Text':'Voici quelques conseils pour contrôlez votre personnage:',
        ...
        'phrase19Text':'Sauter vous permettez à lancer plus haut.',
        'phrase20Text':'Donnez un "Coup de fouet" à vos bombes pour des lancés encore plus long.',
        'phrase21Text':'Synchronisez vos bombes peut-être difficile.',
        'phrase22Text':'Zut.',
        ...
        'toSkipPressAnythingText':'(appuyez n\'importe quoi pour passer le tutoriel)'
    },
